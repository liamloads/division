...
const twexxorDivisionCalculator = function(_16_4, _16_5) {
	...
	if (_16_7[1] === _16_2([_16_7[0], _16_7[1]])) {
		_16_5 = _16_6[1] - _16_6[0];
		_16_6[0] += _16_5 + 1;
		_16_7[0] += _16_3('0', _16_5);
		_16_11 += _16_5;
	}

	_16_5 = _16_7[1];
	_16_6 = _16_1(_16_5, _16_5);
	_16_8 = _16_7[0];
	_16_9 = _16_1(_16_8, '-' + _16_6);
	_16_10 = 0;
	let _16_12 = 0;
	let _16_13 = 1;
	let _16_14 = 0;
	...
	while (_16_15 === true) {
		...
		while (_16_9[0] !== '-') {
			_16_6 = _16_1(_16_6, _16_6);
			_16_12 = _16_1(_16_6, _16_10);
			_16_9 = _16_1(_16_8, '-' + _16_12);
			_16_14 += _16_14;
			_16_13 += _16_14;
		}

		_16_12 = _16_1(_16_5, _16_10);
		_16_14 = _16_1(_16_12, '-' + _16_8);
		_16_15 = _16_14[0] === '-';
	}
